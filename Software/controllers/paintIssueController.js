...
async function consumeLines(tx, issueId, paintWHID, lines, note, userInfo) {
    ...
    for (const l of lines) {
        ...
        // Unlike Paint GRN, issuing against the item's own raw weight UOM is
        // CORRECT and expected here — a job draws an exact weight of
        // material, not whole cans — so there is no UOM to reject (owner
        // report 2026-08-24; see PaintIssue.jsx's uomOptsForItem for the
        // full explanation of why GRN and Issue differ here).
