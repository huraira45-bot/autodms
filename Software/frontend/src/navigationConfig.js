...
export const NAV_ITEMS = [
    ...
    { id: 's-payvoid',   moduleGroup: 'sales', label: 'Payment Voids',         path: '/sales/payment-voids',     icon: Undo2,        anyPermissions: ['sales_executive', 'sales_agm', 'sales_gm', 'am_approve', 'admin_unfinalize', 'sales_admin_settings'], description: 'Undo a payment recorded by mistake: AM approves, admin executes.', keywords: 'void payment reverse refund mistake', isQueue: true },
    { id: 's-histbook',  moduleGroup: 'sales', label: 'Historical Booking',    path: '/sales/historical-booking', icon: Undo2,       anyPermissions: ['sales_admin_settings', 'sales_gm'], description: 'Enter a deal done before DealerDesk and link its payments to vouchers already in the ledger.', keywords: 'historical past old backdated legacy link voucher' },
    { id: 's-histlink',  moduleGroup: 'sales', label: 'Historical Payment Links', path: '/sales/historical-links', icon: Undo2,      anyPermissions: ['sales_admin_settings', 'sales_gm', 'sales_agm'], description: 'Tie payments on old bookings to the vouchers already posted in the ledger.', keywords: 'historical link voucher ledger payment match', isQueue: true },
    ...
    { id: 'hr-mess',     moduleGroup: 'hr', label: 'Mess Sheet',                path: '/hr/mess-sheet',          icon: Utensils,     moduleKey: 'hr_salary',     description: 'Monthly mess days + rate per employee.', keywords: 'mess food canteen' },
    ...
    { id: 'r-recv-sub',  moduleGroup: 'reports', section: 'Financial Statements',  label: 'Receivables Sub-Ledger', path: '/reports/receivables-subledger', icon: ListChecks, permission: 'report:receivables_subledger', description: 'Trial-balance extract of one trade-receivables group, party by party, with each party ledger one click away.' },
    ...
    { id: 'r-p-ssr-custom-settings', moduleGroup: 'reports', section: 'Party Ledgers & Aging', label: 'Hidden Parties (Custom View)', path: '/reports/store-sale-receivables-custom/settings', icon: SettingsIcon, permission: 'report:store_sale_receivables_custom', description: 'Pick which parties are left out of Store Sale Receivables (Custom View).' },
    ...
    { id: 'r-cce',       moduleGroup: 'reports', section: 'Sales Analytics',       label: 'Cash/Credit vs Expense', path: '/reports/cash-credit-expense', icon: ListChecks, permission: 'report:cash_credit_expense', description: 'Store Sale & Job Card: Cash vs Credit revenue against direct cost.' },
    ...
    { id: 'r-p-margin',  moduleGroup: 'reports', section: 'Parts & Inventory',     label: 'JC Parts Cost & Margin', path: '/reports/parts/jc-cost-margin', icon: ListChecks, permission: 'report:jc_parts_cost_margin', description: 'Part cost job-card-wise per business unit — each item with its purchase price, sale price and margin.' },
