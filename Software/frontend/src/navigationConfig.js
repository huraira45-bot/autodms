...
export const NAV_ITEMS = [
    ...
    { id: 'r-p-ssr',     moduleGroup: 'reports', label: 'Store Sale Receivables', path: '/reports/store-sale-receivables', icon: ListChecks, permission: 'report:store_sale_receivables' },
