...
export default function HrBankLetterPrint() {
    ...
    return (
        <div className="letter">
            ...
            <p>Dear Sir/Madam,</p>
            <p>Please debit our account for the salaries of the {empCount} employees listed below and transfer the amounts to their respective accounts as per the schedule.</p>
            <p><b>Cheque No.:</b> {chequeNo} &nbsp;&nbsp;&nbsp; <b>Cheque Date:</b> {chequeDate} &nbsp;&nbsp;&nbsp; <b>Total:</b> Rs. {fmt(total)}</p>
