...
router.get('/party-outstanding-by-type', requireAccess('report:party_outstanding_by_type'), reports.getPartyOutstandingByType);
router.get('/recovery-by-type',       requireAccess('report:recovery_by_type'),       reports.getRecoveryByType);
