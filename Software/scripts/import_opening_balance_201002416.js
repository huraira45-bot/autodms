 ...
 *
 *   Credit  201002416                   PKR   448,970.00
 *   Debit   301001001  Capital Account  PKR   448,970.00
 *   Date    2026-07-01
 *
 * Same voucher-header + posting pattern as import_opening_balances_2026_07.js.
...
const PARTY_CODE     = '201002416';
const CAPITAL_CODE   = '301001001';
const AMOUNT         = 448970.00;
const VOUCHER_PREFIX = 'JV-OB-201002416';
const VOUCHER_DATE   = new Date('2026-07-01T00:00:00');
const REMARKS        = 'Opening balance 2026-07-01 — 201002416 Cr 448,970 vs Capital';
...
(async () => {
    ...
    try {
        ...
        // Two lines: Dr Capital, Cr 201002416.
        const lines = [
