...
const SECTIONS = [
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'report:party_outstanding_by_type', label: 'Unpaid by Party Category (aging)', kind: 'report' },
            { key: 'report:recovery_by_type',       label: 'Recovery by Party Category', kind: 'report' },
            { key: 'report:party_job_cards',        label: 'Party Job Card History (paid / unpaid)', kind: 'report' },
