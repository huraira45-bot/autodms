-- 074_view_jc_add_customerdob.sql
-- Owner report 2026-07-10: DOB label prints on the Work Order but the value
-- cell is always blank. Root cause: vw_WorkshopJobCards never selected DOB
-- from addata_CustomerInfo, so the print payload had no field to render.
-- Add c.DOB AS CustomerDOB; the print template will bind jc.CustomerDOB.
-- Same pattern as 064_view_jc_add_wacresults.
...
PRINT '074_view_jc_add_customerdob.sql complete.';
GO
