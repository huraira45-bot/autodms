...
- ⏳ Phase 2 signature → job card (needs saveJobCard / issuePartsToJobCard extracted into services), Phase 3 parts requisition + bay screen, Phase 4 revisions/re-sign.
